 ...
 "cells": [
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "array([ 3, 50, 70, 59, 41,  3, 52, 77, 15, 37])"
      ]
     },
     "execution_count": 3,
     "metadata": {},
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "array([56, 14, 72, 76,  7, 67, 37, 68, 41, 13])"
      ]
     },
     "execution_count": 4,
     "metadata": {},
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "Requirement already satisfied: numpy in /Users/yusufbayindir/opt/anaconda3/lib/python3.8/site-packages (from researchpy) (1.20.1)\n",
      "Requirement already satisfied: scipy in /Users/yusufbayindir/opt/anaconda3/lib/python3.8/site-packages (from researchpy) (1.6.2)\n",
      "Requirement already satisfied: statsmodels in /Users/yusufbayindir/opt/anaconda3/lib/python3.8/site-packages (from researchpy) (0.12.2)\n",
      "Requirement already satisfied: pandas in /Users/yusufbayindir/opt/anaconda3/lib/python3.8/site-packages (from researchpy) (1.2.4)\n",
      "Requirement already satisfied: patsy in /Users/yusufbayindir/opt/anaconda3/lib/python3.8/site-packages (from researchpy) (0.5.1)\n",
      "Requirement already satisfied: python-dateutil>=2.7.3 in /Users/yusufbayindir/opt/anaconda3/lib/python3.8/site-packages (from pandas->researchpy) (2.8.1)\n",
      "Requirement already satisfied: pytz>=2017.3 in /Users/yusufbayindir/opt/anaconda3/lib/python3.8/site-packages (from pandas->researchpy) (2021.1)\n",
      "Requirement already satisfied: six in /Users/yusufbayindir/opt/anaconda3/lib/python3.8/site-packages (from patsy->researchpy) (1.15.0)\n",
      "Installing collected packages: researchpy\n",
      "Successfully installed researchpy-0.3.2\n",
      "\u001b[33mWARNING: You are using pip version 22.0.4; however, version 22.1.1 is available.\n",
      "You should consider upgrading via the '/Users/yusufbayindir/opt/anaconda3/bin/python -m pip install --upgrade pip' command.\u001b[0m\u001b[33m\n",
      "\u001b[0m"
     ]
    }
   ],
  ...
  },
  {
   ...
   "source": [
    ...
    "# İki rastgele değişkenin kendi ort arasındaki ki rastgele değişkenin \n",
    "# birlikte ortaya çıkardığı ilişki incelenir."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "#pmf -> probability mass function fonksiyonunu giriyoruz. k=1 derken TRUE olma olasılığı\n",
    "# k = 0 ise yanlış olma olasılığı"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "image/png": "\n",
      "text/plain": [
       "<Figure size 432x288 with 1 Axes>"
      ]
     },
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "image/png": "\n",
      "text/plain": [
       "<Figure size 432x288 with 1 Axes>"
      ]
     },
